...
## Project Structure
    ...
    ├── testapiautosetting_127280  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127280`
...
2. Clone this repo and `cd testapiautosetting_127280`
